 ...
 * Jan 16, 2019
 * Description:
 * This is a class which is a template for an object that can be used to create circles.
 * We used this to populate our connect 4 grid for better user interface
 */
